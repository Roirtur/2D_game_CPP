...
int main(int ac, char **av) {
    ...
    Map* map { new Map{0, 0, 1000, 700, 330, 250, (char*)"../ressources/spritesheets/map.png", screen->get_render()} };
    Player* player { new Player{100, 280, 72, 72, 24, 24, 2, DOWN, (char *)"../ressources/spritesheets/Link_Standing.png", screen->get_render()}};

    std::vector<Projectile*> all_projectile_array;

    Projectile* projectile1 { new Projectile{500, 500, 24, 24, 24, 24, 1, DOWN, (char *)"../ressources/spritesheets/Link_Standing.png", screen->get_render()} };
    all_projectile_array.push_back(projectile1);
    
    Projectile* projectile2 { new Projectile{20, 800, 24, 24, 24, 24, 1, DOWN, (char *)"../ressources/spritesheets/Link_Standing.png", screen->get_render()} };
